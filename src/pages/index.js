...
<div class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12">
  ...
  <div class="relative bg-indigo-300 px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 font-mono my-4 w-full sm:mx-auto sm:rounded-lg sm:px-10 md:w-1/2 xl:w-1/3">
